...
public class ButtonAnimator : MonoBehaviour
{
    ...
    [SerializeField] private float delayBeforeAnimation = 1f; // Tiempo antes de empezar la animaci�n
    ...
    private IEnumerator AnimateButtons()
    {
        ...
        // Espera antes de iniciar la animaci�n
        ...
        while (elapsedTime < animationDuration)
        {
            ...
            for (int i = 0; i < buttons.Length; i++)
            {
                ...
                {
                    // Interpolaci�n de posici�n y escala
        ...
        // Aseg�rate de que terminen exactamente en las posiciones y escalas finales
        for (int i = 0; i < buttons.Length; i++)
        {
